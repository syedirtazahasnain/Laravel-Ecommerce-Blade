...
<section id="Gslider" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item {{(($key==0)? 'active' : '')}}">
            <img class="first-slide" src="{{$banner->photo}}" style="height: 200%;" alt="First slide">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="single-banner">
                    ...
                    @else
                    <img src="https://t4.ftcdn.net/jpg/00/51/96/31/360_F_51963161_ZIsqaaYu2lj7Tv7EU1cAKxdoHnAbMvBl.jpg/600x370"
                        alt="#">
                    @endif
                    <div class="content">
                        <h3 style="padding-bottom: 200px;">{{$cat->title}}</h3>
